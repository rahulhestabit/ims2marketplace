...
module.exports = {
  ...
  magento: {
    url: process.env.MAGENTO_URL || 'http://musiquedepot.net/rest/',
    consumerKey: process.env.MAGENTO_CONSUMER_KEY || 'y6e9670is6m2o911kcrr7dvbtrdiket9',
    consumerSecret: process.env.MAGENTO_CONSUMER_SECRET || 'tl6tnuuwqgeha0mnrbebambwrjwr5bsn',
    accessToken: process.env.MAGENTO_ACCESS_TOKEN || 'dwfzwn7hvkkjm7smrhq2ehqjmpx411e9',
    accessTokenSecret: process.env.MAGENTO_ACCESS_TOKEN_SECRET || 'pxgedaefxhr50iabvpjkezti3s15mfr3',
